...
- [ ] One work-unit id, existing web UI target, user path, profile, primary archetype, bounded regions, user mode, primary artifact, pressure, input, spatial model, and register are named; unrelated archetypes were split.
...
- [ ] Horizontal and vertical anchors, baselines, control/icon centering, and repeated row/column alignment were inspected in rendered evidence.
- [ ] Internal padding, sibling gaps, group gaps, and section spacing were distinguished and repeated intentionally.
...
- [ ] Small-detail claims use device scale factor `2` evidence or readable focused crops; compressed or tiny captures are not treated as finish proof.
- [ ] Every durable JSON record has a same-facts `.md` companion; material reviews/proposals include synchronized `report.md`, `report.html`, and lossless local report assets.
